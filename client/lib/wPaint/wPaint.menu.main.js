(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    img: 'images/wPaint/main/icons-menu-main.png',
    items: {
      undo: {
        icon: 'generic',
        title: 'Undo',
  ...
  $.extend($.fn.wPaint.cursors, {
    'default': {path: 'images/wPaint/main/cursor-crosshair.png', left: 7, top: 7},
    dropper:   {path: 'images/wPaint/main/cursor-dropper.png', left: 0, top: 12},
    pencil:    {path: 'images/wPaint/main/cursor-pencil.png', left: 0, top: 11.99},
    bucket:    {path: 'images/wPaint/main/cursor-bucket.png', left: 0, top: 10},
    eraser1:   {path: 'images/wPaint/main/cursor-eraser1.png', left: 1, top: 1},
    eraser2:   {path: 'images/wPaint/main/cursor-eraser2.png', left: 2, top: 2},
    eraser3:   {path: 'images/wPaint/main/cursor-eraser3.png', left: 2, top: 2},
    eraser4:   {path: 'images/wPaint/main/cursor-eraser4.png', left: 3, top: 3},
    eraser5:   {path: 'images/wPaint/main/cursor-eraser5.png', left: 3, top: 3},
    eraser6:   {path: 'images/wPaint/main/cursor-eraser6.png', left: 4, top: 4},
    eraser7:   {path: 'images/wPaint/main/cursor-eraser7.png', left: 4, top: 4},
    eraser8:   {path: 'images/wPaint/main/cursor-eraser8.png', left: 5, top: 5 },
    eraser9:   {path: 'images/wPaint/main/cursor-eraser9.png', left: 5, top: 5},
    eraser10:  {path: 'images/wPaint/main/cursor-eraser10.png', left: 6, top: 6}
  });
